                	...
                	<c:forEach items="${customerIWriteReview}" var="write">
                        ...
                        <div class="guideManageReview_main_review_top">
                            <div class="guideManageReview_main_review_top_column">
                                <div class="review_top_column_profile">
                                	<c:choose>
                                		<c:when test="${write.memberBasicVo.member_profile_photo == 'n'}">
                                			<a href="./credit_infoPage?member_idx=${write.memberBasicVo.member_idx}" class="guideReservation_photo_column ">
                                    			<img src="myPageImg/basic_img.jpg" class="guideReservation_photo">
                                    		</a> 
                                		</c:when>
                                		<c:otherwise>
                                			<a href="./credit_infoPage?member_idx=${write.memberBasicVo.member_idx}" class="guideReservation_photo_column ">
                                    			<img src="${write.memberBasicVo.member_profile_photo}" class="guideReservation_photo">
                                    		</a>
                                		</c:otherwise>
                                	</c:choose>
                                    
                                    <div>${write.memberBasicVo.member_nick }</div>
                                </div>
                        ...
                        <ul  class="guideManageReview_main_review_bottom  review_panel hide" >
                            <li class="guideManageReview_main_review_bottom_column">
                                <div class="review_bottom_column_review">${write.guide_EvaluationBasicVo.guide_review }</div>
                                <div class="review_bottom_column_score">
                                    <img src="myPageImg/star-on-small.png" class="review_bottom_column_star_img">
                                    <div class="review_bottom_column_star_value">${write.guide_EvaluationBasicVo.guide_score }</div>
                                </div>
                            </li>  
                        </ul>
                    </li>
                		...
                		<li class="guideManageReview_main_review_wrap menu">
                            <div class="getreview_top_column_get_top">
                                <div class=" getreview_top_column_get">
                                    <div class="review_top_column_profile">
                                    	<c:choose>
                                    		<c:when test="${got.memberBasicVo.member_profile_photo == 'n'}">
                                    			<a href="./credit_infoPage?member_idx=${got.memberBasicVo.member_idx}" class="guideReservation_photo_column ">
                                        			<img src="myPageImg/basic_img.jpg" class="guideReservation_photo">
                                       			 </a> 
                                    		</c:when>
                                    		<c:otherwise>
                                    			<a href="./credit_infoPage?member_idx=${got.memberBasicVo.member_idx}" class="guideReservation_photo_column ">
                                        			<img src="${got.memberBasicVo.member_profile_photo}" class="guideReservation_photo">
                                       			 </a>
                                    		</c:otherwise>
                                    	</c:choose>
                                        
                                        <div>${got.memberBasicVo.member_nick}</div>
                                    </div>
                                    <div class="guideManage_task_div "></div>
                                    <div>${got.tourBasicVo.tour_intro}</div> 
                                </div>
                            </div>
                                <a  class="review_flip">
                                    <i class="fas fa-sort-down"></i>
                            ...
                            <ul  class="guideManageReview_main_review_bottom  review_panel hide" >
                                <li class=" getreview_top_column_get_bottom">
                                    <div class="review_bottom_column_review">${got.guide_EvaluationBasicVo.guide_review }</div>
                                    <div class="review_bottom_column_score">
                                        <img src="myPageImg/star-on-small.png" class="review_bottom_column_star_img">
                                        <div class="review_bottom_column_star_value">${got.guide_EvaluationBasicVo.guide_score }</div>
                                    </div>
                                </li>  
                            </ul>
                        </li>
