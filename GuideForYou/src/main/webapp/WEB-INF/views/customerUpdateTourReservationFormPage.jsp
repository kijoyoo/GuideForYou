            ...
            <form action="./customerUpdateTourReservationFormPageAction" method="post" class="tourReservationPage_main-form">
                ...
                <div class="tourReservationPage_form-tourSummary">
                     <div class="tourReservationPage_form-tourSummary_tourGuide">
                     	<c:choose>
                     		<c:when test="${customerRData.memberGVo.member_profile_photo == 'n'}">
                     			<img alt="#member_photo"class="tourReservationPage_tourSummary-guidePhoto" src="MainImages/basicMemberProfile.jpg">
                     		</c:when>
                     		<c:otherwise>
                     			<img alt="#member_photo"class="tourReservationPage_tourSummary-guidePhoto" src="${customerRData.memberGVo.member_profile_photo}">
                     		</c:otherwise>
                     	</c:choose>
